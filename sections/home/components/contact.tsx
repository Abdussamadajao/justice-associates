...
const ContactSection = () => {
  ...
  const handleSubmit = async (data: ContactFormData) => {
    const formattedData = {
      ...data,
      practiceArea:
        practiceAreas.find((area) => area.value === data.practiceArea)?.label ||
        data.practiceArea,
    };
    ...
    <section className="section-padding bg-white" id="contact">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-sm font-medium text-law-gold uppercase tracking-wider">
            Get In Touch
          </h2>
          <h3 className="mt-3 text-3xl md:text-4xl font-serif font-bold text-law-navy mb-6">
            Contact Us
          </h3>
          <p className="text-gray-700">
            Have a legal question or need representation? Contact our team for a
            confidential consultation to discuss your legal needs.
          </p>
        </div>
